...
class NoteModel: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(NoteList, forKey: "NoteList")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            NoteList = unarchiver.decodeObject(forKey: "NoteList") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        let 地址 = self.documentsDirectory().appending("NoteList.plist")
        return 地址
    }
}
